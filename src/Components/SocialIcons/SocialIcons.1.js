...
const SocialIcons = (props, context) => {
  ...
  return (
    <div className="social-icons animate-icons">
        ...
        <a target="_blank" rel="noopener noreferrer" href="https://twitter.com/flexdinesh" ><i className="fab fa-twitter"></i></a>
        <a target="_blank" rel="noopener noreferrer" href="https://stackoverflow.com/story/flexdinesh" ><i className="fab fa-stack-overflow"></i></a>
        <a target="_blank" rel="noopener noreferrer" href="https://www.linkedin.com/in/dineshpandiyan" ><i className="fab fa-linkedin"></i></a>
